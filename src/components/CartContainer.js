   ...
   animate={{opacity:1 , x:0}}
    ...
    flex flex-col z-[101]'>
         ...
         <div className='w-full flex items-center justify-between p-4 cursor-pointer'>
          ...
          onClick={clearCart}>Clear <RiRefreshFill/></motion.p>
         </div>
         ...
         <div className='w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col'>
            ...
            flex flex-col items-center justify-evenly px-8 py-2'>
              ...
              <div  className='w-full flex items-center justify-between'>
                ...
                <p className='text-gray-200 text-xl font-semibold'>${tot + 3.5}</p>
              </div>
              ...
              {user ? (
                ...
                whileTap={{scale :0.8}}
                type='button'
                className='w-full p-2 rounded-full bg-gradient-to-r from-purple-500 to-emerald-600
