    ...
    <header className='fixed z-50 w-screen  p-3 px-4 md:p-6 md:px-16 bg-primary' >
         ...
         <div className='hidden md:flex w-full h-full items-center justify-between'>
          ...
          className='flex items-center gap-8 '>
            ...
            <li  className='text-base text-textColor hover:text-headingColor duration-100 
            transition-all ease-in-out cursor-pointer' >Food</li>
            <li  className='text-base text-textColor hover:text-headingColor duration-100 
          ...
          onClick={login} />
               {
                isMenu && (
                  ...
                  top-12 right-0 '>
                   {
                     user && user.email === "darshanjain.godha@gmail.com" && (
                      <Link  to={"/createItem"}>
                   ...
                   <p className='px-4 py-2 flex items-center bg-blue-400
                   gap-3 cursor-pointer hover:bg-lime-300 transition-all
                   duration-100 ease-in-out text-textColor text-base'
                   onClick={logout} >Logout <HiOutlineLogout/></p>
                 </motion.div>
                )
               }
          ...
          onClick={login} />
               {
                isMenu && (
                  ...
                  top-12 right-0 '>
                   ...
                   gap-3 cursor-pointer hover:bg-orange-300 transition-all
...
<ul className='flex flex-col   '>
            ...
            onClick={() => setIsMenu(false)}>Service</li>
                   ...
                   gap-3 cursor-pointer hover:bg-blue-300 transition-all
                   duration-100 ease-in-out text-textColor text-base'
                   onClick={logout} >Logout <HiOutlineLogout/></p>
                 </motion.div>
                )
